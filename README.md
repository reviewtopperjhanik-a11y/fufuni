...
```
apps/mcp/src/knowledge/generated/*.md          ← static knowledge files (one per topic, generated by a script)
       ↓
...
Each `apps/mcp/src/knowledge/generated/<topic>.md` file becomes:
